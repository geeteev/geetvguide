...
#MAIN_URL = 'http://gantv.ca/gtv/guide/ini/'
MAIN_URL = 'http://geetee.site/guide/'
...
class FileFetcher(object):
    ...
    basePath = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.geetvguide'))
    filePath = ''
    fileUrl = ''
    addon = None
    ...
    def fetchFile(self):
        ...
        if fetch:
            ...
            if os.path.getsize(tmpFile) > 256:
                ...
                xbmc.log('[script.geetvguide] file %s was downloaded' % self.filePath, xbmc.LOGDEBUG)
            else:
